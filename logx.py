...
class Logger:
    ...
    def save_config(self, config):
        ...
        #OSS 10/01/2022 removed proc_id since no mpi
        if True:
        #if proc_id()==0:
...
class EpochLogger(Logger):
    ...
    def log_tabular(self, key, val=None, with_min_and_max=False, average_only=False):
        ...
        if val is not None:
            ...
            #print("*** debugging EpRet issue. key is : ")
            #print(key)
            # Omer Sella: temporary fix: I have an issue with EpLen and EpRet not being in the dictionary if the trajectory hasn't terminated.
